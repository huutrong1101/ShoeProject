...
@WebServlet(name = "LoadMoreNikeControl", urlPatterns = { "/ajax/loadNike" })
public class LoadMoreNikeControl extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		List<Product> list = productServices.getNext4NikeProduct(iamount);
		...
		for (Product o : list) {
			...
			out.println("<div class=\"productNike col-lg-3 col-md-6\">\r\n"
