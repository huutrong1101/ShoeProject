...
@WebServlet(name = "LoadMoreAdidasControl", urlPatterns = { "/ajax/loadAdidas" })
public class LoadMoreAdidasControl extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		List<Product> list = productServices.getNext4AdidasProduct(iamount);
		...
		for (Product o : list) {
			...
			out.println("<div class=\"productAdidas col-lg-3 col-md-6\">\r\n"
