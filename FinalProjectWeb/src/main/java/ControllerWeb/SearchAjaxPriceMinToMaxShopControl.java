...
@WebServlet(name = "SearchAjaxPriceMinToMaxShopControl", urlPatterns = { "/ajax/searchAjaxPriceMinToMax" })
public class SearchAjaxPriceMinToMaxShopControl extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		List<Product> list = productServices.searchByPriceMinToMax(priceMin, priceMax);
