...
@WebServlet(urlPatterns = { "/shipper/successShipper" })
public class SuccessShipperControler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<InvoiceShop> listAllInvoice = invoiceShopServices.getAllRequestInvoiceShop(4);

		request.setAttribute("listAllInvoice", listAllInvoice);

		request.getRequestDispatcher("/views/shipper/InvoiceSuccess.jsp").forward(request, response);
	}
