...
@WebServlet(urlPatterns = { "/shipper" })
public class HomeShipperControler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<InvoiceShop> listAllInvoice = invoiceShopServices.getAllRequestInvoiceShop(2);

		request.setAttribute("listAllInvoice", listAllInvoice);

		request.getRequestDispatcher("/views/shipper/HomeShipper.jsp").forward(request, response);
	}
