...
@WebServlet(urlPatterns = { "/seller/loadProduct" })
public class LoadProductControler extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/views/seller/Edit.jsp").forward(request, response);
	}
